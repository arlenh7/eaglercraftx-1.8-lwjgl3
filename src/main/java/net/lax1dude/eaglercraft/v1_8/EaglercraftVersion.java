...
public class EaglercraftVersion {
	...
	public static final String projectForkName = "EaglercraftX LWJGL3";
	public static final String projectForkVersion = "u1";
	public static final String projectForkVendor = "arlen";
	
	public static final String projectForkURL = "https://github.com/arlenh7/eaglercraft-1.8-lwjgl3";
	
	//////////////////////////////////////////////////////////////////////
	
	public static final String projectOriginName = "EaglercraftX LWJGL3";
	public static final String projectOriginAuthor = "arlen";
	public static final String projectOriginRevision = "1.8";
	public static final String projectOriginVersion = "u1";
	
	public static final String projectOriginURL = "https://github.com/arlenh7/eaglercraft-1.8-lwjgl3"; // rest in peace
